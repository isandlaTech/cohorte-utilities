...
public interface IActivityFormater {
	...
	public final static EActivityLogColumn[] LINE_CONSOLE = {
			EActivityLogColumn.C3_DATE, EActivityLogColumn.C4_TIME,
			EActivityLogColumn.C7_INSTANCE, EActivityLogColumn.C8_METHOD,
			EActivityLogColumn.C9_TEXT };

	public final static EActivityLogColumn[] LINE_SIMPLEFORMATER = {
			EActivityLogColumn.C6_THREAD, EActivityLogColumn.C7_INSTANCE,
			EActivityLogColumn.C8_METHOD, EActivityLogColumn.C9_TEXT };
