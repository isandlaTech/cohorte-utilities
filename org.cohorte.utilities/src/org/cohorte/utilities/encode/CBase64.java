...
public class CBase64 {
		...
		public void write(int theByte) throws java.io.IOException {
			...
			// Else, Decoding
				...
				if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC) {
					...
					{
						int len = CBase64.decode4to3(buffer, 0, b4, 0);
						out.write(b4, 0, len);
						// out.write( CBase64..decode4to3( buffer ) );
						position = 0;
					} // end if: enough to output
				} // end if: meaningful CBase64. character
	...
	// Indicates white space inencoding
	...
	public static byte[] decodeFromFile(String filename) {
		...
		try {
			...
			// Open a stream
			bis = new CBase64.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(file)), CBase64.DECODE);
	...
	public static boolean decodeToFile(String dataToDecode, String filename) {
		...
		CBase64.OutputStream bos = null;
		try {
			bos = new CBase64.OutputStream(new java.io.FileOutputStream(
					filename), CBase64.DECODE);
	...
	public static String encodeBytes(byte[] source, int off, int len,
		...
		if (gzip == GZIP) {
			...
			CBase64.OutputStream b64os = null;

			try {
				// GZip -> Base64 -> ByteArray
				baos = new java.io.ByteArrayOutputStream();
				b64os = new CBase64.OutputStream(baos, ENCODE | dontBreakLines);
	 ...
	 * @since 2.1
	 */
	public static String encodeFromFile(final File aFile) {
		String encodedData = null;
		CBase64.InputStream bis = null;
		try {
			// Set up some useful variables
			java.io.File file = new java.io.File(aFile.getAbsolutePath());
			...
			// Open a stream
			bis = new CBase64.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(file)), CBase64.ENCODE);
	 ...
	 * @return
	 */
	public static String encodeString(final String source) {
