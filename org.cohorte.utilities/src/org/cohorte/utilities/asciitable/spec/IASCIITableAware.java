 ...
 */
package org.cohorte.utilities.asciitable.spec;

import java.util.List;

import org.cohorte.utilities.asciitable.ASCIITableHeader;

/**
 * An ASCII table interface for extracting the header, data and formatted cell
 * data.
 * 
...
public interface IASCIITableAware {
    ...
    /**
     * Returns the formatted data item for a particular cell. Return <null> if you
     * don't want to format the data. It uses String.valueOf(data) as cell value in
     * that case.
     * 
     * @param header
     * @param data
