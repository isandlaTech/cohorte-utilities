 ...
 */
package org.cohorte.utilities.asciitable.impl;
...
/**
 * This class is useful to extract the header and row data from a list of java
 * beans.
 * 
...
public class CollectionASCIITableAware<T> implements IASCIITableAware {
	...
	if (objList != null && !objList.isEmpty() && properties != null && !properties.isEmpty()) {
		...
		for (int j = 0; j < properties.size(); j++) {
		    rowData.add(getProperty(propertyMethodMap, dataClazz, objList.get(i), properties.get(j)));
		}
