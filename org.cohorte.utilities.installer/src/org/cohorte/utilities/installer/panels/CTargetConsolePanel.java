 ...
 *
 */
public class CTargetConsolePanel extends TargetConsolePanel {
	 ...
	 * @param prompt
	 */
	public CTargetConsolePanel(PanelView<ConsolePanel> panel, InstallData installData, Prompt prompt) {
