package org.cohorte.utilities.lib.mysql.docs;
...
import org.cohorte.utilities.lib.mysql.Activator;
...
public class CDocs {
	 ...
	 * @throws IOException
	 */
	public static String getDocHtml() throws IOException {

		return readResourceText(buildDocResourcePath("connector-j.html"));
	 ...
	 * @return
	 */
	public static byte[] getDocPdf() throws IOException {

		return readResourceBin(buildDocResourcePath("connector-j.pdf"),
				ONE_MEGA_BYTES);
