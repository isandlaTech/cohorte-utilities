 ...
 *
 */
public class CUpdaterPanel extends IzPanel implements IConstants {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1725256103873211391L;
	 ...
	 * @param log
	 */
	public CUpdaterPanel(Panel panel, InstallerFrame parent, GUIInstallData installData, Resources resources,
			Log log) {
	 ...
	 * @param resources
	 */
	public CUpdaterPanel(Panel panel, InstallerFrame parent, GUIInstallData installData,
		...
		/*
		 * pInstallButton = new
		 * JRadioButton(getString("installer.updater.installButton"));
		 * pInstallButton.addActionListener(new ActionListener() {
		 * 
		 * @Override public void actionPerformed(ActionEvent e) {
		 * selectInstall(); } }); add(pInstallButton, NEXT_LINE);
		 */
		...
		// wDescriptionPanel.setLayout(new BoxLayout(wDescriptionPanel,
		// BoxLayout.PAGE_AXIS));
		wDescriptionPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder(""),
	...
	public void panelActivate() {
		...
		pInstalledVersionLabel.setText("<html>" + getString("installer.updater.installedVersionLabel")
				+ "<font color='red'>" + pInstalledVersion + "</font></html>");
		pNewVersionLabel.setText("<html>" + getString("installer.updater.newVersionLabel")
				+ "<font color='green'>" + pNewVersion + "</font></html>");
		selectUpdate();
	...
	private void selectUpdate() {
		...
		pDescriptionLabel.setText("<html><font>" + getString("installer.updater.updateButtonDescription")
				+ "</font></html>");
	}

	/*
	 * private void selectInstall() { pUpdateButton.setSelected(false);
	 * pInstallButton.setSelected(true); pUninstallButton.setSelected(false);
	 * pInstallData.setVariable(INSTALLER__DO_ACTION, "install");
	 * pDescriptionLabel.setText("<html><font>"+getString(
	 * "installer.updater.installButtonDescription")+"</font></html>"); }
	 */
	...
	private void selectUninstall() {
		...
		pDescriptionLabel.setText("<html><font>" + getString("installer.updater.uninstallButtonDescription")
				+ "</font></html>");
	}
