...
public final class RhinoScriptEngine extends AbstractScriptEngine implements Invocable, Compilable {
	...
	static {
		ContextFactory.initGlobal(new ContextFactory() {
			/**
			 * Execute top call to script or function. When the runtime is about to execute
			 * a script or function that will create the first stack frame with scriptable
			 * code, it calls this method to perform the real call. In this way execution of
			 * any script happens inside this function.
			 */
			@Override
	...
	/*
	 * Scope where standard JavaScript objects and our extensions to it are stored.
	 * Note that these are not user defined engine level global variables. These are
	 * variables have to be there on all compliant ECMAScript scopes. We put these
	 * standard objects in this top level.
	 */
